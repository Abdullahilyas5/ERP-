...
export function ModuleLayout({ title, subtitle, headerActions, children, allowedRoles = [] }) {
  return (
    <ToastProvider>
      <div className="min-h-screen bg-slate-100 px-4 py-6 text-slate-800 md:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 lg:flex-row">
          ...
          <ProtectedRoute allowedRoles={allowedRoles}>
            <main className="flex-1 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-7">
